            ...
            <div class="card-body">
                <form action="{{ route('vehicle-types.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Motor, Mobil, Truk" required>
                        @error('name')
                    ...
                    <div class="text-end mt-4">
                        <button type="submit" class="btn bg-gradient-primary">
                            <i class="fa-solid fa-floppy-disk me-1"></i> Save Vehicle Type
                        </button>
                    </div>
                </form>
            </div>
