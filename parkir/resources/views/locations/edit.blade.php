                ...
                <form action="{{ route('locations.update', $location->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" class="form-control @error('capacity_motor') is-invalid @enderror" id="capacity_motor" name="capacity_motor" value="{{ old('capacity_motor', $location->capacity_motor) }}" min="0" required>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" class="form-control @error('capacity_car') is-invalid @enderror" id="capacity_car" name="capacity_car" value="{{ old('capacity_car', $location->capacity_car) }}" min="0" required>
                            @error('capacity_car')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" class="form-control @error('capacity_truck') is-invalid @enderror" id="capacity_truck" name="capacity_truck" value="{{ old('capacity_truck', $location->capacity_truck) }}" min="0" required>
